const sections = [
  {
    title: '1. Services',
    content:
      'Smart Healthcare and Research Ltd. provides online healthcare consultation services by licensed doctors through video calls, chats, and digital platforms. Our services are intended to support, not replace, in-person medical care when necessary.',
  },
  {
