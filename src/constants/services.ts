...
const services = [
  {
    ...
    features: [
      ...
      'Accessible anywhere in a fixed time',
  ...
  },
  {
    ...
    features_name: 'Training Includes',
    features: [
      'Workshops and seminars',
      'Hands-on clinical training',
      'Digital healthcare management skills',
    ],
  },
  {
    id: 4,
    ...
    features_name: 'Resources Provided',
    features: [
      'Guideline on maternal and child healthcare and nutrition',
      'Interactive educational tools, health tips and expert advices',
...

  {
    ...
    features_name: 'Outreach Programs',
    features: [
      'Access for undeserved and hard-to-reach populations',
  ...
  },
  {
    ...
    features_name: 'Academic Contributions',
    features: [
      'Publish research findings on maternal and child health',
