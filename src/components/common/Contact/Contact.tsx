...
const Contact = () => {
  return (
    <div className="relative bg-[url('/images/banner/bg2.jpg')] dark:bg-none bg-cover bg-center bg-no-repeat py-24 min-h-[calc(100vh-351px)] flex flex-col items-center justify-center">
